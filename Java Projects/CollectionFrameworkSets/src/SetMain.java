...
public class SetMain {
    ...
    2. Elementleri alfabetik olarak sıralarlar.(C++ ,Java , python) vb.
    ...
    */
        ...
        */
        ...
        set3.add("Php");
        set3.add("Javascript");
        set3.add("Php");// aynı elemanlardan 1 tane ekleyebiliyoruz listemize 
        ...
        System.out.println(set1.contains("Php")); // varsa true yoksa false döner
        System.out.println(set1.contains("Go"));
        System.out.println(set1.isEmpty()); // set1 boşsa true doluysa false dönüyor
        set1.remove("Java"); // java set1 den silinir.
        */
        ...
        Set<String> fark = new HashSet<String>(set2); // set2 yazarak fark kümemizin set2 ye eşit olmasını istiyoruz
        System.out.println(fark); // fark ın tüm elemanları
        System.out.println(fark.removeAll(set1)); // Bu kısımda da farktaki elemanları set1 den  (fark - set 1 = sonuç) çıkartmış oluyoruz, eğer sonuç kümemiz boş küme değilse true döner eğer boşsa false döner
        System.out.println(fark); // burada kaldırılan elemanlar dışındakiler bastırılır
    
        Set<String> kesisim = new HashSet<String>(set2);
        
        System.out.println(kesisim.retainAll(set1)); // kesisimi var mı ona bakıyor varsa true yoksa false dönüyor
        System.out.println(kesisim); // kesisen elemanları bastırır
